...
- (instancetype)initOrgJodaConvertStringConvertWithBoolean:(BOOL)includeJdkConverters
  ...
  if (self = [super init]) {
    ...
    for (int i = 0; i < (int) [((IOSObjectArray *) nil_chk(factories)) count]; i++) {
    ...
    if (includeJdkConverters) {
      {
        IOSObjectArray *a__ = [OrgJodaConvertJDKStringConverterEnum values];
    ...
    if ((int) [factories count] > 0) {
      [self->factories_ addAllWithJavaUtilCollection:[JavaUtilArrays asListWithNSObjectArray:factories]];
    }
...
- (id<OrgJodaConvertTypedStringConverter>)findTypedConverterWithIOSClass:(IOSClass *)cls {
  ...
  if (conv == nil) {
    @throw [[JavaLangIllegalStateException alloc] initWithNSString:[NSString stringWithFormat:@"No registered converter found: %@", cls]];
  }
  return conv;
}
...
- (id<OrgJodaConvertTypedStringConverter>)findAnyConverterWithIOSClass:(IOSClass *)cls {
  ...
  for (id<OrgJodaConvertStringConverterFactory> __strong factory in nil_chk(factories_)) {
    ...
    if (factoryConv != nil) {
      return [OrgJodaConvertTypedAdapter adaptWithIOSClass:cls withOrgJodaConvertStringConverter:factoryConv];
    }
  }
  return nil;
}
...
withOrgJodaConvertStringConverter:(id<OrgJodaConvertStringConverter>)converter {
  ...
  (void) [((id<JavaUtilConcurrentConcurrentMap>) nil_chk(registered_)) putWithId:cls withId:[OrgJodaConvertTypedAdapter adaptWithIOSClass:cls withOrgJodaConvertStringConverter:converter]];
}
...
- (JavaLangReflectMethod *)findToStringMethodWithIOSClass:(IOSClass *)cls
  ...
  if ([JavaLangReflectModifier isStaticWithInt:[((JavaLangReflectMethod *) nil_chk(m)) getModifiers]]) {
    @throw [[JavaLangIllegalArgumentException alloc] initWithNSString:[NSString stringWithFormat:@"Method must not be static: %@", methodName]];
  }
  return m;
}
...
- (JavaLangReflectMethod *)findFromStringMethodWithIOSClass:(IOSClass *)cls
  ...
  if ([JavaLangReflectModifier isStaticWithInt:[((JavaLangReflectMethod *) nil_chk(m)) getModifiers]] == NO) {
    @throw [[JavaLangIllegalArgumentException alloc] initWithNSString:[NSString stringWithFormat:@"Method must be static: %@", methodName]];
  }
  return m;
}
...
+ (void)initialize {
  if (self == [OrgJodaConvertStringConvert class]) {
    ...
    OrgJodaConvertStringConvert_initialized = YES;
  }
}
...
+ (J2ObjcClassInfo *)__metadata {
  ...
  static J2ObjcClassInfo _OrgJodaConvertStringConvert = { "StringConvert", "org.joda.convert", NULL, 0x11, 23, methods, 4, fields, 0, NULL};
...
+ (J2ObjcClassInfo *)__metadata {
  ...
  static J2ObjcClassInfo _OrgJodaConvertStringConvert_$1 = { "$1", "org.joda.convert", "StringConvert", 0x8000, 4, methods, 0, NULL, 0, NULL};
...
+ (J2ObjcClassInfo *)__metadata {
  ...
  static J2ObjcClassInfo _OrgJodaConvertStringConvert_$2 = { "$2", "org.joda.convert", "StringConvert", 0x8000, 4, methods, 3, fields, 0, NULL};
