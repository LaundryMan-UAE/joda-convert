...
//  source: /Users/andrewebling/Laundrapp/Joda-time-Project/Joda-Convert/src/main/java/org/joda/convert/factory/ByteObjectArrayStringConverterFactory.java
//
...
+ (void)initialize {
  if (self == [OrgJodaConvertFactoryByteObjectArrayStringConverterFactory class]) {
    ...
    OrgJodaConvertFactoryByteObjectArrayStringConverterFactory_initialized = YES;
  }
}
...
+ (J2ObjcClassInfo *)__metadata {
  ...
  static J2ObjcClassInfo _OrgJodaConvertFactoryByteObjectArrayStringConverterFactory = { "ByteObjectArrayStringConverterFactory", "org.joda.convert.factory", NULL, 0x11, 3, methods, 1, fields, 0, NULL};
...
OrgJodaConvertFactoryByteObjectArrayStringConverterFactory_ByteArrayStringConverterEnum *OrgJodaConvertFactoryByteObjectArrayStringConverterFactory_ByteArrayStringConverterEnum_values[1];
...
+ (void)initialize {
  if (self == [OrgJodaConvertFactoryByteObjectArrayStringConverterFactory_ByteArrayStringConverterEnum class]) {
    ...
    OrgJodaConvertFactoryByteObjectArrayStringConverterFactory_ByteArrayStringConverterEnum_initialized = YES;
  }
}

+ (IOSObjectArray *)values {
  return [IOSObjectArray arrayWithObjects:OrgJodaConvertFactoryByteObjectArrayStringConverterFactory_ByteArrayStringConverterEnum_values count:1 type:[IOSClass classWithClass:[OrgJodaConvertFactoryByteObjectArrayStringConverterFactory_ByteArrayStringConverterEnum class]]];
}
...
+ (OrgJodaConvertFactoryByteObjectArrayStringConverterFactory_ByteArrayStringConverterEnum *)valueOfWithNSString:(NSString *)name {
  for (int i = 0; i < 1; i++) {
    OrgJodaConvertFactoryByteObjectArrayStringConverterFactory_ByteArrayStringConverterEnum *e = OrgJodaConvertFactoryByteObjectArrayStringConverterFactory_ByteArrayStringConverterEnum_values[i];
...
+ (J2ObjcClassInfo *)__metadata {
  static J2ObjcMethodInfo methods[] = {
    ...
    { "convertToStringWithJavaLangByteArray:", "convertToString", "Ljava.lang.String;", 0x401, NULL },
    { "convertFromStringWithIOSClass:withNSString:", "convertFromString", "[Ljava.lang.Byte;", 0x401, NULL },
  ...
  static J2ObjcClassInfo _OrgJodaConvertFactoryByteObjectArrayStringConverterFactory_ByteArrayStringConverterEnum = { "ByteArrayStringConverter", "org.joda.convert.factory", "ByteObjectArrayStringConverterFactory", 0x4408, 4, methods, 3, fields, 1, superclass_type_args};
...
- (NSString *)convertToStringWithId:(IOSObjectArray *)array {
  ...
  for (int i = 0; i < (int) [array count]; i++) {
    if (IOSObjectArray_Get(array, i) == nil) {
      ...
      int b = [((JavaLangByte *) nil_chk(IOSObjectArray_Get(array, i))) charValue];
      (void) [((JavaLangStringBuilder *) nil_chk([buf appendWithChar:[((NSString *) nil_chk(OrgJodaConvertFactoryByteObjectArrayStringConverterFactory_ByteArrayStringConverterEnum_get_HEX_())) charAtWithInt:(int) (((unsigned int) (b & (int) 0xF0)) >> 4)]])) appendWithChar:[OrgJodaConvertFactoryByteObjectArrayStringConverterFactory_ByteArrayStringConverterEnum_get_HEX_() charAtWithInt:b & (int) 0x0F]];
    }
  }
...
- (IOSObjectArray *)convertFromStringWithIOSClass:(IOSClass *)cls
  ...
  IOSObjectArray *array = [IOSObjectArray arrayWithLength:((int) [str length]) / 2 type:[IOSClass classWithClass:[JavaLangByte class]]];
  for (int i = 0; i < (int) [array count]; i++) {
    ...
    if ([((NSString *) nil_chk(in)) isEqual:@"--"]) {
      ...
      (void) IOSObjectArray_Set(array, i, [JavaLangByte valueOfWithByte:(char) [JavaLangInteger parseIntWithNSString:in withInt:16]]);
    }
  }
  return array;
}
...
+ (J2ObjcClassInfo *)__metadata {
  ...
  static J2ObjcClassInfo _OrgJodaConvertFactoryByteObjectArrayStringConverterFactory_ByteArrayStringConverterEnum_$1 = { "$1", "org.joda.convert.factory", "ByteObjectArrayStringConverterFactory$ByteArrayStringConverter", 0xc010, 4, methods, 0, NULL, 0, NULL};
