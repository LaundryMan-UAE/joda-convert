...
//  source: /Users/andrefonseca/Documents/PodsFolders/joda-convert/src/main/java/org/joda/convert/RenameHandler.java
//
...
+ (const J2ObjcClassInfo *)__metadata {
  static const J2ObjcMethodInfo methods[] = {
    ...
    { "renamedTypeWithNSString:withIOSClass:", "renamedType", "V", 0x1, NULL, "(Ljava/lang/String;Ljava/lang/Class<*>;)V" },
    { "getTypeRenames", NULL, "Ljava.util.Map;", 0x1, NULL, "()Ljava/util/Map<Ljava/lang/String;Ljava/lang/Class<*>;>;" },
    { "lookupTypeWithNSString:", "lookupType", "Ljava.lang.Class;", 0x1, "Ljava.lang.ClassNotFoundException;", "(Ljava/lang/String;)Ljava/lang/Class<*>;" },
    { "loadTypeWithNSString:", "loadType", "Ljava.lang.Class;", 0x2, "Ljava.lang.ClassNotFoundException;", "(Ljava/lang/String;)Ljava/lang/Class<*>;" },
    { "renamedEnumWithNSString:withJavaLangEnum:", "renamedEnum", "V", 0x1, NULL, "(Ljava/lang/String;Ljava/lang/Enum<*>;)V" },
    { "getEnumTypesWithRenames", NULL, "Ljava.util.Set;", 0x1, NULL, "()Ljava/util/Set<Ljava/lang/Class<*>;>;" },
    { "getEnumRenamesWithIOSClass:", "getEnumRenames", "Ljava.util.Map;", 0x1, NULL, "(Ljava/lang/Class<*>;)Ljava/util/Map<Ljava/lang/String;Ljava/lang/Enum<*>;>;" },
  ...
  static const J2ObjcFieldInfo fields[] = {
    { "INSTANCE", "INSTANCE", 0x19, "Lorg.joda.convert.RenameHandler;", &OrgJodaConvertRenameHandler_INSTANCE, NULL, .constantValue.asLong = 0 },
