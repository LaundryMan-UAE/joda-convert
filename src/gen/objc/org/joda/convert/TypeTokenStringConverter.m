...
#include "org/joda/convert/TypeTokenStringConverter.h"

@implementation OrgJodaConvertTypeTokenStringConverter

- (instancetype)initPackagePrivate {
  OrgJodaConvertTypeTokenStringConverter_initPackagePrivate(self);
  return self;
}
...
void OrgJodaConvertTypeTokenStringConverter_initPackagePrivate(OrgJodaConvertTypeTokenStringConverter *self) {
  OrgJodaConvertAbstractTypeStringConverter_initPackagePrivate(self);
}

OrgJodaConvertTypeTokenStringConverter *new_OrgJodaConvertTypeTokenStringConverter_initPackagePrivate() {
  J2OBJC_NEW_IMPL(OrgJodaConvertTypeTokenStringConverter, initPackagePrivate)
}

OrgJodaConvertTypeTokenStringConverter *create_OrgJodaConvertTypeTokenStringConverter_initPackagePrivate() {
  J2OBJC_CREATE_IMPL(OrgJodaConvertTypeTokenStringConverter, initPackagePrivate)
}
