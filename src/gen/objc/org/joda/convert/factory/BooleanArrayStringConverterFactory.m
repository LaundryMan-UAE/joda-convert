...
__attribute__((unused)) static OrgJodaConvertFactoryBooleanArrayStringConverterFactory *new_OrgJodaConvertFactoryBooleanArrayStringConverterFactory_init(void) NS_RETURNS_RETAINED;

__attribute__((unused)) static OrgJodaConvertFactoryBooleanArrayStringConverterFactory *create_OrgJodaConvertFactoryBooleanArrayStringConverterFactory_init(void);

inline IOSBooleanArray *OrgJodaConvertFactoryBooleanArrayStringConverterFactory_BooleanArrayStringConverter_get_EMPTY(void);
...
@interface OrgJodaConvertFactoryBooleanArrayStringConverterFactory_BooleanArrayStringConverter_1 : OrgJodaConvertFactoryBooleanArrayStringConverterFactory_BooleanArrayStringConverter
...
J2OBJC_EMPTY_STATIC_INIT(OrgJodaConvertFactoryBooleanArrayStringConverterFactory_BooleanArrayStringConverter_1)

__attribute__((unused)) static void OrgJodaConvertFactoryBooleanArrayStringConverterFactory_BooleanArrayStringConverter_1_initWithNSString_withInt_(OrgJodaConvertFactoryBooleanArrayStringConverterFactory_BooleanArrayStringConverter_1 *self, NSString *__name, jint __ordinal);
...
- (OrgJodaConvertFactoryBooleanArrayStringConverterFactory_BooleanArrayStringConverter_Enum)toNSEnum {
  return (OrgJodaConvertFactoryBooleanArrayStringConverterFactory_BooleanArrayStringConverter_Enum)[self ordinal];
}
...
+ (const J2ObjcClassInfo *)__metadata {
  ...
  static const void *ptrTable[] = { "valueOf", "LNSString;", &JreEnum(OrgJodaConvertFactoryBooleanArrayStringConverterFactory_BooleanArrayStringConverter, INSTANCE), &OrgJodaConvertFactoryBooleanArrayStringConverterFactory_BooleanArrayStringConverter_EMPTY, "LOrgJodaConvertFactoryBooleanArrayStringConverterFactory;", "Ljava/lang/Enum<Lorg/joda/convert/factory/BooleanArrayStringConverterFactory$BooleanArrayStringConverter;>;Lorg/joda/convert/TypedStringConverter<[Z>;" };
...
+ (void)initialize {
  if (self == [OrgJodaConvertFactoryBooleanArrayStringConverterFactory_BooleanArrayStringConverter class]) {
    size_t allocSize = 0;
    size_t objSize_INSTANCE = class_getInstanceSize([OrgJodaConvertFactoryBooleanArrayStringConverterFactory_BooleanArrayStringConverter_1 class]);
    allocSize += objSize_INSTANCE;
    uintptr_t ptr = (uintptr_t)calloc(allocSize, 1);
    id e;
    ((void) (JreEnum(OrgJodaConvertFactoryBooleanArrayStringConverterFactory_BooleanArrayStringConverter, INSTANCE) = e = objc_constructInstance([OrgJodaConvertFactoryBooleanArrayStringConverterFactory_BooleanArrayStringConverter_1 class], (void *)ptr)), ptr += objSize_INSTANCE);
    OrgJodaConvertFactoryBooleanArrayStringConverterFactory_BooleanArrayStringConverter_1_initWithNSString_withInt_(e, @"INSTANCE", 0);
...
@implementation OrgJodaConvertFactoryBooleanArrayStringConverterFactory_BooleanArrayStringConverter_1
...
- (IOSBooleanArray *)convertFromStringWithIOSClass:(IOSClass *)cls
  ...
  IOSBooleanArray *array = [IOSBooleanArray arrayWithLength:[str java_length]];
  for (jint i = 0; i < array->size_; i++) {
    ...
    if (ch == 'T') {
      ...
      *IOSBooleanArray_GetRef(array, i) = false;
      ...
      @throw create_JavaLangIllegalArgumentException_initWithNSString_(@"Invalid boolean[] string, must consist only of 'T' and 'F'");
    }
  }
  return array;
}
...
- (void)dealloc {
  JreCheckFinalize(self, [OrgJodaConvertFactoryBooleanArrayStringConverterFactory_BooleanArrayStringConverter_1 class]);
  [super dealloc];
}
...
+ (const J2ObjcClassInfo *)__metadata {
  ...
  #pragma clang diagnostic pop
  static const void *ptrTable[] = { "convertToString", "[Z", "convertFromString", "LIOSClass;LNSString;", "(Ljava/lang/Class<+[Z>;Ljava/lang/String;)[Z", "()Ljava/lang/Class<*>;", "LOrgJodaConvertFactoryBooleanArrayStringConverterFactory_BooleanArrayStringConverter;" };
  static const J2ObjcClassInfo _OrgJodaConvertFactoryBooleanArrayStringConverterFactory_BooleanArrayStringConverter_1 = { "", "org.joda.convert.factory", ptrTable, methods, NULL, 7, 0xc018, 3, 0, 6, -1, -1, -1, -1 };
  return &_OrgJodaConvertFactoryBooleanArrayStringConverterFactory_BooleanArrayStringConverter_1;
}

@end

void OrgJodaConvertFactoryBooleanArrayStringConverterFactory_BooleanArrayStringConverter_1_initWithNSString_withInt_(OrgJodaConvertFactoryBooleanArrayStringConverterFactory_BooleanArrayStringConverter_1 *self, NSString *__name, jint __ordinal) {
