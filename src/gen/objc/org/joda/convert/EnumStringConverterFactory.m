...
//  source: /Users/marcussmith/Laundryman/Libraries/joda-convert/src/main/java/org/joda/convert/EnumStringConverterFactory.java
//
...
__attribute__((unused)) static void OrgJodaConvertEnumStringConverterFactory_initPackagePrivate(OrgJodaConvertEnumStringConverterFactory *self);

__attribute__((unused)) static OrgJodaConvertEnumStringConverterFactory *new_OrgJodaConvertEnumStringConverterFactory_initPackagePrivate(void) NS_RETURNS_RETAINED;

__attribute__((unused)) static OrgJodaConvertEnumStringConverterFactory *create_OrgJodaConvertEnumStringConverterFactory_initPackagePrivate(void);
...
- (instancetype)initPackagePrivate {
  OrgJodaConvertEnumStringConverterFactory_initPackagePrivate(self);
  return self;
}
...
- (id<OrgJodaConvertStringConverter>)findConverterWithIOSClass:(IOSClass *)cls {
  ...
  if (sup == JavaLangEnum_class_()) {
    return create_OrgJodaConvertEnumStringConverterFactory_EnumStringConverter_initWithOrgJodaConvertEnumStringConverterFactory_withIOSClass_(self, cls);
  }
  else if (sup != nil && [sup getSuperclass] == JavaLangEnum_class_()) {
    return create_OrgJodaConvertEnumStringConverterFactory_EnumStringConverter_initWithOrgJodaConvertEnumStringConverterFactory_withIOSClass_(self, sup);
  }
  return nil;
}
...
+ (void)initialize {
  if (self == [OrgJodaConvertEnumStringConverterFactory class]) {
    JreStrongAssignAndConsume(&OrgJodaConvertEnumStringConverterFactory_INSTANCE, new_OrgJodaConvertEnumStringConverterFactory_initPackagePrivate());
...
void OrgJodaConvertEnumStringConverterFactory_initPackagePrivate(OrgJodaConvertEnumStringConverterFactory *self) {
  NSObject_init(self);
}

OrgJodaConvertEnumStringConverterFactory *new_OrgJodaConvertEnumStringConverterFactory_initPackagePrivate() {
  J2OBJC_NEW_IMPL(OrgJodaConvertEnumStringConverterFactory, initPackagePrivate)
}

OrgJodaConvertEnumStringConverterFactory *create_OrgJodaConvertEnumStringConverterFactory_initPackagePrivate() {
  J2OBJC_CREATE_IMPL(OrgJodaConvertEnumStringConverterFactory, initPackagePrivate)
}
