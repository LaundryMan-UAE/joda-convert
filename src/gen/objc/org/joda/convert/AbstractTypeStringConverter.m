...
inline NSString *OrgJodaConvertAbstractTypeStringConverter_get_EXTENDS(void);
...
inline NSString *OrgJodaConvertAbstractTypeStringConverter_get_SUPER(void);
...
inline ComGoogleCommonCollectImmutableMap *OrgJodaConvertAbstractTypeStringConverter_get_PRIMITIVES(void);
...
inline JavaLangReflectMethod *OrgJodaConvertAbstractTypeStringConverter_get_NEW_PARAM_TYPE(void);
...
inline JavaLangReflectMethod *OrgJodaConvertAbstractTypeStringConverter_get_EXTENDS_TYPE(void);
...
inline JavaLangReflectMethod *OrgJodaConvertAbstractTypeStringConverter_get_SUPER_TYPE(void);
  ...
  if (self == [OrgJodaConvertAbstractTypeStringConverter class]) {
    JreStrongAssign(&OrgJodaConvertAbstractTypeStringConverter_PRIMITIVES, [((ComGoogleCommonCollectImmutableMap_Builder *) nil_chk([((ComGoogleCommonCollectImmutableMap_Builder *) nil_chk([((ComGoogleCommonCollectImmutableMap_Builder *) nil_chk([((ComGoogleCommonCollectImmutableMap_Builder *) nil_chk([((ComGoogleCommonCollectImmutableMap_Builder *) nil_chk([((ComGoogleCommonCollectImmutableMap_Builder *) nil_chk([((ComGoogleCommonCollectImmutableMap_Builder *) nil_chk([((ComGoogleCommonCollectImmutableMap_Builder *) nil_chk([((ComGoogleCommonCollectImmutableMap_Builder *) nil_chk(ComGoogleCommonCollectImmutableMap_builder())) putWithId:@"byte" withId:[IOSClass byteClass]])) putWithId:@"short" withId:[IOSClass shortClass]])) putWithId:@"int" withId:[IOSClass intClass]])) putWithId:@"long" withId:[IOSClass longClass]])) putWithId:@"boolean" withId:[IOSClass booleanClass]])) putWithId:@"char" withId:[IOSClass charClass]])) putWithId:@"float" withId:[IOSClass floatClass]])) putWithId:@"double" withId:[IOSClass doubleClass]])) build]);
    {
      @try {
        ...
        JavaLangReflectMethod *newParam = [((IOSClass *) nil_chk(typesClass)) getDeclaredMethod:@"newParameterizedType" parameterTypes:[IOSObjectArray arrayWithObjects:(id[]){ IOSClass_class_(), IOSClass_arrayType(JavaLangReflectType_class_(), 1) } count:2 type:IOSClass_class_()]];
        [((JavaLangReflectMethod *) nil_chk(newParam)) setAccessibleWithBoolean:true];
        JreStrongAssign(&OrgJodaConvertAbstractTypeStringConverter_NEW_PARAM_TYPE, newParam);
        JavaLangReflectMethod *extendsType = [typesClass getDeclaredMethod:@"subtypeOf" parameterTypes:[IOSObjectArray arrayWithObjects:(id[]){ JavaLangReflectType_class_() } count:1 type:IOSClass_class_()]];
        [((JavaLangReflectMethod *) nil_chk(extendsType)) setAccessibleWithBoolean:true];
        JreStrongAssign(&OrgJodaConvertAbstractTypeStringConverter_EXTENDS_TYPE, extendsType);
        JavaLangReflectMethod *superType = [typesClass getDeclaredMethod:@"supertypeOf" parameterTypes:[IOSObjectArray arrayWithObjects:(id[]){ JavaLangReflectType_class_() } count:1 type:IOSClass_class_()]];
        [((JavaLangReflectMethod *) nil_chk(superType)) setAccessibleWithBoolean:true];
        JreStrongAssign(&OrgJodaConvertAbstractTypeStringConverter_SUPER_TYPE, superType);
      }
...
void OrgJodaConvertAbstractTypeStringConverter_initPackagePrivate(OrgJodaConvertAbstractTypeStringConverter *self) {
  NSObject_init(self);
}
...
id<JavaLangReflectType> OrgJodaConvertAbstractTypeStringConverter_doParseWithNSString_(NSString *str) {
  ...
  jint first = [((NSString *) nil_chk(str)) java_indexOf:'<'];
  if (first < 0) {
    return [((OrgJodaConvertRenameHandler *) nil_chk(JreLoadStatic(OrgJodaConvertRenameHandler, INSTANCE))) loadTypeWithNSString:str];
  }
  jint last = [str java_lastIndexOf:'>'];
  NSString *baseStr = [str java_substring:0 endIndex:first];
  ...
  NSString *argsStr = [str java_substring:first + 1 endIndex:last];
  id<JavaUtilList> splitArgs = OrgJodaConvertAbstractTypeStringConverter_splitWithNSString_(argsStr);
  id<JavaUtilList> types = create_JavaUtilArrayList_init();
  for (NSString * __strong splitArg in nil_chk(splitArgs)) {
    id<JavaLangReflectType> argType;
    if ([((NSString *) nil_chk(splitArg)) java_hasPrefix:OrgJodaConvertAbstractTypeStringConverter_EXTENDS]) {
      NSString *remainder = [splitArg java_substring:[((NSString *) nil_chk(OrgJodaConvertAbstractTypeStringConverter_EXTENDS)) java_length]];
    ...
    else if ([splitArg java_hasPrefix:OrgJodaConvertAbstractTypeStringConverter_SUPER]) {
      NSString *remainder = [splitArg java_substring:[((NSString *) nil_chk(OrgJodaConvertAbstractTypeStringConverter_SUPER)) java_length]];
    ...
    else if ([splitArg java_hasSuffix:@"[]"]) {
      NSString *componentStr = [splitArg java_substring:0 endIndex:[splitArg java_length] - 2];
      IOSClass *componentCls = [JreLoadStatic(OrgJodaConvertRenameHandler, INSTANCE) loadTypeWithNSString:componentStr];
      argType = [nil_chk(JavaLangReflectArray_newInstanceWithIOSClass_withInt_(componentCls, 0)) java_getClass];
    }
    else if ([splitArg java_hasPrefix:@"[L"] && [splitArg java_hasSuffix:@";"]) {
      NSString *componentStr = [splitArg java_substring:2 endIndex:[splitArg java_length] - 1];
      IOSClass *componentCls = [JreLoadStatic(OrgJodaConvertRenameHandler, INSTANCE) loadTypeWithNSString:componentStr];
      argType = [nil_chk(JavaLangReflectArray_newInstanceWithIOSClass_withInt_(componentCls, 0)) java_getClass];
    }
    else {
  ...
  return OrgJodaConvertAbstractTypeStringConverter_newParameterizedTypeWithIOSClass_withJavaLangReflectTypeArray_(base, [types toArrayWithNSObjectArray:[IOSObjectArray arrayWithLength:[types size] type:JavaLangReflectType_class_()]]);
}
...
id<JavaUtilList> OrgJodaConvertAbstractTypeStringConverter_splitWithNSString_(NSString *str) {
  ...
  for (jint i = 0; i < [((NSString *) nil_chk(str)) java_length]; i++) {
    if ([str charAtWithInt:i] == ',' && genericCount == 0) {
      [result addWithId:[((NSString *) nil_chk([str java_substring:startPos endIndex:i])) java_trim]];
      startPos = i + 1;
    }
  ...
  [result addWithId:[((NSString *) nil_chk([str java_substring:startPos])) java_trim]];
  return result;
}
...
id<JavaLangReflectType> OrgJodaConvertAbstractTypeStringConverter_wildExtendsTypeWithJavaLangReflectType_(id<JavaLangReflectType> bound) {
  OrgJodaConvertAbstractTypeStringConverter_initialize();
  return (id<JavaLangReflectType>) cast_check([((JavaLangReflectMethod *) nil_chk(OrgJodaConvertAbstractTypeStringConverter_EXTENDS_TYPE)) invokeWithId:nil withNSObjectArray:[IOSObjectArray arrayWithObjects:(id[]){ bound } count:1 type:NSObject_class_()]], JavaLangReflectType_class_());
}
...
id<JavaLangReflectType> OrgJodaConvertAbstractTypeStringConverter_wildSuperTypeWithJavaLangReflectType_(id<JavaLangReflectType> bound) {
  OrgJodaConvertAbstractTypeStringConverter_initialize();
  return (id<JavaLangReflectType>) cast_check([((JavaLangReflectMethod *) nil_chk(OrgJodaConvertAbstractTypeStringConverter_SUPER_TYPE)) invokeWithId:nil withNSObjectArray:[IOSObjectArray arrayWithObjects:(id[]){ bound } count:1 type:NSObject_class_()]], JavaLangReflectType_class_());
}
...
id<JavaLangReflectParameterizedType> OrgJodaConvertAbstractTypeStringConverter_newParameterizedTypeWithIOSClass_withJavaLangReflectTypeArray_(IOSClass *base, IOSObjectArray *args) {
  OrgJodaConvertAbstractTypeStringConverter_initialize();
  return (id<JavaLangReflectParameterizedType>) cast_check([((JavaLangReflectMethod *) nil_chk(OrgJodaConvertAbstractTypeStringConverter_NEW_PARAM_TYPE)) invokeWithId:nil withNSObjectArray:[IOSObjectArray arrayWithObjects:(id[]){ base, args } count:2 type:NSObject_class_()]], JavaLangReflectParameterizedType_class_());
}
