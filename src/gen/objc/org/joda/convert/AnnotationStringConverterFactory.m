...
//  source: /Users/marcussmith/Laundryman/Libraries/joda-convert/src/main/java/org/joda/convert/AnnotationStringConverterFactory.java
//
...
__attribute__((unused)) static void OrgJodaConvertAnnotationStringConverterFactory_initPackagePrivate(OrgJodaConvertAnnotationStringConverterFactory *self);

__attribute__((unused)) static OrgJodaConvertAnnotationStringConverterFactory *new_OrgJodaConvertAnnotationStringConverterFactory_initPackagePrivate(void) NS_RETURNS_RETAINED;

__attribute__((unused)) static OrgJodaConvertAnnotationStringConverterFactory *create_OrgJodaConvertAnnotationStringConverterFactory_initPackagePrivate(void);
...
- (instancetype)initPackagePrivate {
  OrgJodaConvertAnnotationStringConverterFactory_initPackagePrivate(self);
  return self;
}
...
+ (void)initialize {
  if (self == [OrgJodaConvertAnnotationStringConverterFactory class]) {
    JreStrongAssignAndConsume(&OrgJodaConvertAnnotationStringConverterFactory_INSTANCE, new_OrgJodaConvertAnnotationStringConverterFactory_initPackagePrivate());
...
void OrgJodaConvertAnnotationStringConverterFactory_initPackagePrivate(OrgJodaConvertAnnotationStringConverterFactory *self) {
  NSObject_init(self);
}

OrgJodaConvertAnnotationStringConverterFactory *new_OrgJodaConvertAnnotationStringConverterFactory_initPackagePrivate() {
  J2OBJC_NEW_IMPL(OrgJodaConvertAnnotationStringConverterFactory, initPackagePrivate)
}

OrgJodaConvertAnnotationStringConverterFactory *create_OrgJodaConvertAnnotationStringConverterFactory_initPackagePrivate() {
  J2OBJC_CREATE_IMPL(OrgJodaConvertAnnotationStringConverterFactory, initPackagePrivate)
}
...
id<OrgJodaConvertStringConverter> OrgJodaConvertAnnotationStringConverterFactory_findAnnotatedConverterWithIOSClass_(OrgJodaConvertAnnotationStringConverterFactory *self, IOSClass *cls) {
  ...
  if (con == nil && mth == nil) {
    @throw create_JavaLangIllegalStateException_initWithNSString_(JreStrcat("$$", @"Class annotated with @ToString but not with @FromString: ", [((IOSClass *) nil_chk(cls)) getName]));
  }
  if (con != nil && mth != nil) {
    @throw create_JavaLangIllegalStateException_initWithNSString_(JreStrcat("$$", @"Both method and constructor are annotated with @FromString: ", [((IOSClass *) nil_chk(cls)) getName]));
  }
  ...
  while (loopCls != nil && matched == nil) {
    IOSObjectArray *methods = [loopCls getDeclaredMethods];
    {
      ...
      while (b__ < e__) {
        ...
        if (toString != nil) {
          if (matched != nil) {
            @throw create_JavaLangIllegalStateException_initWithNSString_(JreStrcat("$$", @"Two methods are annotated with @ToString: ", [((IOSClass *) nil_chk(cls)) getName]));
          }
          matched = method;
        }
      }
      ...
      while (b__ < e__) {
        ...
        IOSObjectArray *methods = [((IOSClass *) nil_chk(loopIfc)) getDeclaredMethods];
        {
          ...
          while (b__ < e__) {
            ...
            if (toString != nil) {
              if (matched != nil) {
                @throw create_JavaLangIllegalStateException_initWithNSString_(JreStrcat("$$", @"Two methods are annotated with @ToString on interfaces: ", [((IOSClass *) nil_chk(cls)) getName]));
              }
              matched = method;
            }
          }
...
OrgJodaConvertMethodConstructorStringConverter *OrgJodaConvertAnnotationStringConverterFactory_findFromStringConstructorWithIOSClass_withJavaLangReflectMethod_(OrgJodaConvertAnnotationStringConverterFactory *self, IOSClass *cls, JavaLangReflectMethod *toString) {
  ...
  return create_OrgJodaConvertMethodConstructorStringConverter_initPackagePrivateWithIOSClass_withJavaLangReflectMethod_withJavaLangReflectConstructor_(cls, toString, con);
}
...
OrgJodaConvertMethodsStringConverter *OrgJodaConvertAnnotationStringConverterFactory_findFromStringMethodWithIOSClass_withJavaLangReflectMethod_withBoolean_(OrgJodaConvertAnnotationStringConverterFactory *self, IOSClass *cls, JavaLangReflectMethod *toString, jboolean searchSuperclasses) {
  ...
  while (loopCls != nil) {
    ...
    if (fromString != nil) {
      return create_OrgJodaConvertMethodsStringConverter_initPackagePrivateWithIOSClass_withJavaLangReflectMethod_withJavaLangReflectMethod_withIOSClass_(cls, toString, fromString, loopCls);
    }
  ...
  if (searchSuperclasses) {
    {
      ...
      while (b__ < e__) {
        ...
        if (fromString != nil) {
          if (matched != nil) {
            @throw create_JavaLangIllegalStateException_initWithNSString_(JreStrcat("$$", @"Two different interfaces are annotated with @FromString or @FromStringFactory: ", [((IOSClass *) nil_chk(cls)) getName]));
          }
          matched = create_OrgJodaConvertMethodsStringConverter_initPackagePrivateWithIOSClass_withJavaLangReflectMethod_withJavaLangReflectMethod_withIOSClass_(cls, toString, fromString, loopIfc);
        }
      }
    }
  }
...
JavaLangReflectMethod *OrgJodaConvertAnnotationStringConverterFactory_findFromStringWithIOSClass_(OrgJodaConvertAnnotationStringConverterFactory *self, IOSClass *cls) {
  ...
  JavaLangReflectMethod *matched = nil;
  {
    ...
    while (b__ < e__) {
      ...
      if (fromString != nil) {
        if (matched != nil) {
          @throw create_JavaLangIllegalStateException_initWithNSString_(JreStrcat("$$", @"Two methods are annotated with @FromString: ", [cls getName]));
        }
        matched = method;
      }
    }
  ...
  if (factory != nil) {
    if (matched != nil) {
      @throw create_JavaLangIllegalStateException_initWithNSString_(JreStrcat("$$", @"Class annotated with @FromString and @FromStringFactory: ", [cls getName]));
    }
    IOSObjectArray *factoryMethods = [((IOSClass *) nil_chk([factory factory])) getDeclaredMethods];
    {
      ...
      while (b__ < e__) {
        ...
        if ([cls isAssignableFrom:[((JavaLangReflectMethod *) nil_chk(method)) getReturnType]]) {
          ...
          if (fromString != nil) {
            if (matched != nil) {
              @throw create_JavaLangIllegalStateException_initWithNSString_(JreStrcat("$$", @"Two methods are annotated with @FromString on the factory: ", [((IOSClass *) nil_chk([factory factory])) getName]));
            }
            matched = method;
          }
        }
