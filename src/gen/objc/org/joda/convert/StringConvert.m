...
- (void)tryRegisterJava8Optionals;

- (void)tryRegisterTimeZone;
...
__attribute__((unused)) static void OrgJodaConvertStringConvert_tryRegisterJava8Optionals(OrgJodaConvertStringConvert *self);

__attribute__((unused)) static void OrgJodaConvertStringConvert_tryRegisterTimeZone(OrgJodaConvertStringConvert *self);
...
- (void)tryRegisterJava8Optionals {
  OrgJodaConvertStringConvert_tryRegisterJava8Optionals(self);
}

- (void)tryRegisterTimeZone {
  OrgJodaConvertStringConvert_tryRegisterTimeZone(self);
}
...
- (void)registerMethodsWithIOSClass:(IOSClass *)cls
  ...
  OrgJodaConvertMethodsStringConverter *converter = create_OrgJodaConvertMethodsStringConverter_initPackagePrivateWithIOSClass_withJavaLangReflectMethod_withJavaLangReflectMethod_withIOSClass_(cls, toString, fromString, cls);
...
- (void)registerMethodConstructorWithIOSClass:(IOSClass *)cls
  ...
  OrgJodaConvertMethodConstructorStringConverter *converter = create_OrgJodaConvertMethodConstructorStringConverter_initPackagePrivateWithIOSClass_withJavaLangReflectMethod_withJavaLangReflectConstructor_(cls, toString, fromString);
  [((id<JavaUtilConcurrentConcurrentMap>) nil_chk(registered_)) putIfAbsentWithId:cls withId:converter];
}
...
+ (const J2ObjcClassInfo *)__metadata {
  ...
  methods[4].selector = @selector(tryRegisterJava8Optionals);
  methods[5].selector = @selector(tryRegisterTimeZone);
  methods[6].selector = @selector(tryRegisterWithNSString:withNSString:);
  methods[7].selector = @selector(convertToStringWithId:);
  methods[8].selector = @selector(convertToStringWithIOSClass:withId:);
  methods[9].selector = @selector(convertFromStringWithIOSClass:withNSString:);
  methods[10].selector = @selector(isConvertibleWithIOSClass:);
  methods[11].selector = @selector(findConverterWithIOSClass:);
  methods[12].selector = @selector(findConverterNoGenericsWithIOSClass:);
  methods[13].selector = @selector(findTypedConverterWithIOSClass:);
  methods[14].selector = @selector(findTypedConverterNoGenericsWithIOSClass:);
  methods[15].selector = @selector(findConverterQuietWithIOSClass:);
  methods[16].selector = @selector(findAnyConverterWithIOSClass:);
  methods[17].selector = @selector(registerFactoryWithOrgJodaConvertStringConverterFactory:);
  methods[18].selector = @selector(register__WithIOSClass:withOrgJodaConvertStringConverter:);
  methods[19].selector = @selector(register__WithIOSClass:withOrgJodaConvertToStringConverter:withOrgJodaConvertFromStringConverter:);
  methods[20].selector = @selector(registerMethodsWithIOSClass:withNSString:withNSString:);
  methods[21].selector = @selector(registerMethodConstructorWithIOSClass:withNSString:);
  methods[22].selector = @selector(findToStringMethodWithIOSClass:withNSString:);
  methods[23].selector = @selector(findFromStringMethodWithIOSClass:withNSString:);
  methods[24].selector = @selector(findFromStringConstructorByTypeWithIOSClass:);
  ...
  static const J2ObjcClassInfo _OrgJodaConvertStringConvert = { "StringConvert", "org.joda.convert", ptrTable, methods, fields, 7, 0x11, 26, 4, -1, -1, -1, -1, -1 };
...
void OrgJodaConvertStringConvert_tryRegisterGuava(OrgJodaConvertStringConvert *self) {
  @try {
    [((OrgJodaConvertRenameHandler *) nil_chk(JreLoadStatic(OrgJodaConvertRenameHandler, INSTANCE))) loadTypeWithNSString:@"com.google.common.reflect.Types"];
    IOSClass *cls = [JreLoadStatic(OrgJodaConvertRenameHandler, INSTANCE) loadTypeWithNSString:@"org.joda.convert.TypeTokenStringConverter"];
    ...
    [((id<JavaUtilConcurrentConcurrentMap>) nil_chk(self->registered_)) putWithId:[((id<OrgJodaConvertTypedStringConverter>) nil_chk(conv)) getEffectiveType] withId:conv];
    ...
    [self->registered_ putWithId:[((id<OrgJodaConvertTypedStringConverter>) nil_chk(conv2)) getEffectiveType] withId:conv2];
  }
  @catch (JavaLangThrowable *ex) {
  }
}

void OrgJodaConvertStringConvert_tryRegisterJava8Optionals(OrgJodaConvertStringConvert *self) {
  @try {
    [((OrgJodaConvertRenameHandler *) nil_chk(JreLoadStatic(OrgJodaConvertRenameHandler, INSTANCE))) loadTypeWithNSString:@"java.util.OptionalInt"];
    IOSClass *cls1 = [JreLoadStatic(OrgJodaConvertRenameHandler, INSTANCE) loadTypeWithNSString:@"org.joda.convert.OptionalIntStringConverter"];
    id<OrgJodaConvertTypedStringConverter> conv1 = (id<OrgJodaConvertTypedStringConverter>) cast_check([((IOSClass *) nil_chk(cls1)) newInstance], OrgJodaConvertTypedStringConverter_class_());
    [((id<JavaUtilConcurrentConcurrentMap>) nil_chk(self->registered_)) putWithId:[((id<OrgJodaConvertTypedStringConverter>) nil_chk(conv1)) getEffectiveType] withId:conv1];
    IOSClass *cls2 = [JreLoadStatic(OrgJodaConvertRenameHandler, INSTANCE) loadTypeWithNSString:@"org.joda.convert.OptionalLongStringConverter"];
    id<OrgJodaConvertTypedStringConverter> conv2 = (id<OrgJodaConvertTypedStringConverter>) cast_check([((IOSClass *) nil_chk(cls2)) newInstance], OrgJodaConvertTypedStringConverter_class_());
    [self->registered_ putWithId:[((id<OrgJodaConvertTypedStringConverter>) nil_chk(conv2)) getEffectiveType] withId:conv2];
    IOSClass *cls3 = [JreLoadStatic(OrgJodaConvertRenameHandler, INSTANCE) loadTypeWithNSString:@"org.joda.convert.OptionalDoubleStringConverter"];
    id<OrgJodaConvertTypedStringConverter> conv3 = (id<OrgJodaConvertTypedStringConverter>) cast_check([((IOSClass *) nil_chk(cls3)) newInstance], OrgJodaConvertTypedStringConverter_class_());
    [self->registered_ putWithId:[((id<OrgJodaConvertTypedStringConverter>) nil_chk(conv3)) getEffectiveType] withId:conv3];
  }
  @catch (JavaLangThrowable *ex) {
  }
}

void OrgJodaConvertStringConvert_tryRegisterTimeZone(OrgJodaConvertStringConvert *self) {
  @try {
    [((id<JavaUtilConcurrentConcurrentMap>) nil_chk(self->registered_)) putWithId:JavaUtilSimpleTimeZone_class_() withId:JreLoadEnum(OrgJodaConvertJDKStringConverter, TIME_ZONE)];
  }
  @catch (JavaLangThrowable *ex) {
  }
  @try {
    JavaUtilTimeZone *zone = JavaUtilTimeZone_getDefault();
    [self->registered_ putWithId:[((JavaUtilTimeZone *) nil_chk(zone)) java_getClass] withId:JreLoadEnum(OrgJodaConvertJDKStringConverter, TIME_ZONE)];
  }
  @catch (JavaLangThrowable *ex) {
  }
  @try {
    JavaUtilTimeZone *zone = JavaUtilTimeZone_getTimeZoneWithNSString_(@"Europe/London");
    [self->registered_ putWithId:[((JavaUtilTimeZone *) nil_chk(zone)) java_getClass] withId:JreLoadEnum(OrgJodaConvertJDKStringConverter, TIME_ZONE)];
  }
  @catch (JavaLangThrowable *ex) {
  }
...
+ (const J2ObjcClassInfo *)__metadata {
  static J2ObjcMethodInfo methods[] = {
    ...
    { NULL, "LNSString;", 0x1, 1, 2, -1, 3, -1, -1 },
  ...
  #pragma clang diagnostic pop
  static const J2ObjcFieldInfo fields[] = {
    { "val$toString_", "LOrgJodaConvertToStringConverter;", .constantValue.asLong = 0, 0x1012, -1, -1, 8, -1 },
    { "val$fromString_", "LOrgJodaConvertFromStringConverter;", .constantValue.asLong = 0, 0x1012, -1, -1, 9, -1 },
    { "val$cls_", "LIOSClass;", .constantValue.asLong = 0, 0x1012, -1, -1, 10, -1 },
  };
  static const void *ptrTable[] = { "LOrgJodaConvertToStringConverter;LOrgJodaConvertFromStringConverter;LIOSClass;", "convertToString", "LNSObject;", "(TT;)Ljava/lang/String;", "convertFromString", "LIOSClass;LNSString;", "(Ljava/lang/Class<+TT;>;Ljava/lang/String;)TT;", "()Ljava/lang/Class<*>;", "Lorg/joda/convert/ToStringConverter<TT;>;", "Lorg/joda/convert/FromStringConverter<TT;>;", "Ljava/lang/Class<TT;>;", "LOrgJodaConvertStringConvert;", "register__WithIOSClass:withOrgJodaConvertToStringConverter:withOrgJodaConvertFromStringConverter:", "Ljava/lang/Object;Lorg/joda/convert/TypedStringConverter<TT;>;" };
  static const J2ObjcClassInfo _OrgJodaConvertStringConvert_2 = { "", "org.joda.convert", ptrTable, methods, fields, 7, 0x8010, 4, 3, 11, -1, 12, 13, -1 };
