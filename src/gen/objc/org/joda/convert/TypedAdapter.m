...
- (instancetype)initPackagePrivateWithOrgJodaConvertStringConverter:(id<OrgJodaConvertStringConverter>)conv
...
__attribute__((unused)) static void OrgJodaConvertTypedAdapter_initPackagePrivateWithOrgJodaConvertStringConverter_withIOSClass_(OrgJodaConvertTypedAdapter *self, id<OrgJodaConvertStringConverter> conv, IOSClass *effectiveType);

__attribute__((unused)) static OrgJodaConvertTypedAdapter *new_OrgJodaConvertTypedAdapter_initPackagePrivateWithOrgJodaConvertStringConverter_withIOSClass_(id<OrgJodaConvertStringConverter> conv, IOSClass *effectiveType) NS_RETURNS_RETAINED;

__attribute__((unused)) static OrgJodaConvertTypedAdapter *create_OrgJodaConvertTypedAdapter_initPackagePrivateWithOrgJodaConvertStringConverter_withIOSClass_(id<OrgJodaConvertStringConverter> conv, IOSClass *effectiveType);
...
- (instancetype)initPackagePrivateWithOrgJodaConvertStringConverter:(id<OrgJodaConvertStringConverter>)conv
                                                       withIOSClass:(IOSClass *)effectiveType {
  OrgJodaConvertTypedAdapter_initPackagePrivateWithOrgJodaConvertStringConverter_withIOSClass_(self, conv, effectiveType);
  return self;
}
...
+ (const J2ObjcClassInfo *)__metadata {
  ...
  methods[1].selector = @selector(initPackagePrivateWithOrgJodaConvertStringConverter:withIOSClass:);
...
id<OrgJodaConvertTypedStringConverter> OrgJodaConvertTypedAdapter_adaptWithIOSClass_withOrgJodaConvertStringConverter_(IOSClass *cls, id<OrgJodaConvertStringConverter> converter) {
  ...
  if ([OrgJodaConvertTypedStringConverter_class_() isInstance:converter]) {
    ...
    return create_OrgJodaConvertTypedAdapter_initPackagePrivateWithOrgJodaConvertStringConverter_withIOSClass_(converter, cls);
  }
}

void OrgJodaConvertTypedAdapter_initPackagePrivateWithOrgJodaConvertStringConverter_withIOSClass_(OrgJodaConvertTypedAdapter *self, id<OrgJodaConvertStringConverter> conv, IOSClass *effectiveType) {
  NSObject_init(self);
  JreStrongAssign(&self->conv_, conv);
  JreStrongAssign(&self->effectiveType_, effectiveType);
}

OrgJodaConvertTypedAdapter *new_OrgJodaConvertTypedAdapter_initPackagePrivateWithOrgJodaConvertStringConverter_withIOSClass_(id<OrgJodaConvertStringConverter> conv, IOSClass *effectiveType) {
  J2OBJC_NEW_IMPL(OrgJodaConvertTypedAdapter, initPackagePrivateWithOrgJodaConvertStringConverter_withIOSClass_, conv, effectiveType)
}

OrgJodaConvertTypedAdapter *create_OrgJodaConvertTypedAdapter_initPackagePrivateWithOrgJodaConvertStringConverter_withIOSClass_(id<OrgJodaConvertStringConverter> conv, IOSClass *effectiveType) {
  J2OBJC_CREATE_IMPL(OrgJodaConvertTypedAdapter, initPackagePrivateWithOrgJodaConvertStringConverter_withIOSClass_, conv, effectiveType)
}
