...
- (NSString *)convertToStringWithId:(id)object {
  @try {
    return (NSString *) check_class_cast([((JavaLangReflectMethod *) nil_chk(toString_)) invokeWithId:object withNSObjectArray:[IOSObjectArray arrayWithLength:0 type:NSObject_class_()]], [NSString class]);
  }
...
+ (const J2ObjcClassInfo *)__metadata {
  static const J2ObjcMethodInfo methods[] = {
    { "initWithIOSClass:withJavaLangReflectMethod:", "ReflectionStringConverter", NULL, 0x0, NULL, NULL },
