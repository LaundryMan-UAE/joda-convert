...
+ (const J2ObjcClassInfo *)__metadata {
  ...
  methods[0].selector = @selector(initPackagePrivateWithIOSClass:withJavaLangReflectMethod:);
...
void OrgJodaConvertReflectionStringConverter_initPackagePrivateWithIOSClass_withJavaLangReflectMethod_(OrgJodaConvertReflectionStringConverter *self, IOSClass *cls, JavaLangReflectMethod *toString) {
  NSObject_init(self);
