...
- (instancetype)initPackagePrivateWithIOSClass:(IOSClass *)cls
  ...
  OrgJodaConvertMethodsStringConverter_initPackagePrivateWithIOSClass_withJavaLangReflectMethod_withJavaLangReflectMethod_withIOSClass_(self, cls, toString, fromString, effectiveType);
  return self;
}
...
+ (const J2ObjcClassInfo *)__metadata {
  ...
  methods[0].selector = @selector(initPackagePrivateWithIOSClass:withJavaLangReflectMethod:withJavaLangReflectMethod:withIOSClass:);
...
void OrgJodaConvertMethodsStringConverter_initPackagePrivateWithIOSClass_withJavaLangReflectMethod_withJavaLangReflectMethod_withIOSClass_(OrgJodaConvertMethodsStringConverter *self, IOSClass *cls, JavaLangReflectMethod *toString, JavaLangReflectMethod *fromString, IOSClass *effectiveType) {
...
OrgJodaConvertMethodsStringConverter *new_OrgJodaConvertMethodsStringConverter_initPackagePrivateWithIOSClass_withJavaLangReflectMethod_withJavaLangReflectMethod_withIOSClass_(IOSClass *cls, JavaLangReflectMethod *toString, JavaLangReflectMethod *fromString, IOSClass *effectiveType) {
  J2OBJC_NEW_IMPL(OrgJodaConvertMethodsStringConverter, initPackagePrivateWithIOSClass_withJavaLangReflectMethod_withJavaLangReflectMethod_withIOSClass_, cls, toString, fromString, effectiveType)
}

OrgJodaConvertMethodsStringConverter *create_OrgJodaConvertMethodsStringConverter_initPackagePrivateWithIOSClass_withJavaLangReflectMethod_withJavaLangReflectMethod_withIOSClass_(IOSClass *cls, JavaLangReflectMethod *toString, JavaLangReflectMethod *fromString, IOSClass *effectiveType) {
  J2OBJC_CREATE_IMPL(OrgJodaConvertMethodsStringConverter, initPackagePrivateWithIOSClass_withJavaLangReflectMethod_withJavaLangReflectMethod_withIOSClass_, cls, toString, fromString, effectiveType)
}
